							...
							<div class="left-detail">
								...
								<div class="share">
									...
									<ul>
										...
										<li>
											<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>&context='Chào các bạn'">
												<img src="<?php bloginfo('template_directory') ?>/images/sotical2.png" class="img-fluid" alt="">
											</a>
										</li>

										<!-- <li><a href=""><img src="<?php bloginfo('template_directory') ?>/images/sotical3.png" class="img-fluid" alt=""></a></li> -->
					...
					<div class="row">
						<?php
							...
							if ($categories) 
							{
								...
								'post_per_page'=>3, // Số bài viết bạn muốn hiển thị.
								);
